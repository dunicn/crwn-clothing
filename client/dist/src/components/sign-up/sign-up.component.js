...
var form_input_component_1 = __importDefault(require("../form-input/form-input.component"));
...
var SignUp = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: 'sign-up' },
        react_1.default.createElement("h2", { className: 'title' }, "I do not have an account"),
        ...
        react_1.default.createElement("form", { className: 'sign-up-form', onSubmit: handleSubmit },
            react_1.default.createElement(form_input_component_1.default, { type: 'text', name: 'displayName', value: displayName, onChange: handleChange, label: 'Display name', required: true }),
            react_1.default.createElement(form_input_component_1.default, { type: 'email', name: 'email', value: email, onChange: handleChange, label: 'Email', required: true }),
            react_1.default.createElement(form_input_component_1.default, { type: 'password', name: 'password', value: password, onChange: handleChange, label: 'Password', required: true }),
            react_1.default.createElement(form_input_component_1.default, { type: 'password', name: 'confirmPassword', value: confirmPassword, onChange: handleChange, label: 'Confirm Password', required: true }),
