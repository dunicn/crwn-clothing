...
var SignIn = function (_a) {
    ...
    var handleChange = function (event) {
        ...
        setCredentials(__assign(__assign({}, userCredentials), (_a = {}, _a[name] = value, _a)));
    };
    return (react_1.default.createElement("div", { className: 'sign-in' },
        react_1.default.createElement("h2", { className: 'title' }, "I already have an account"),
        react_1.default.createElement("span", null, "Sign in with your email and password"),
        react_1.default.createElement("form", { onSubmit: handleSubmit },
            react_1.default.createElement(form_input_component_1.default, { name: 'email', type: 'email', value: email, handleChange: handleChange, label: 'email', required: true }),
            react_1.default.createElement(form_input_component_1.default, { name: 'password', type: 'password', value: password, handleChange: handleChange, label: 'password', required: true }),
